...
from model import Admin, Student, Project
from exts import db
import config, os
from method import get_Info, to_Data, to_List, to_Json, new_avatar_name # create_xlsx
...
def login():
    data = to_Data()# 函数返回值是一个字典，将json类型转成字典
